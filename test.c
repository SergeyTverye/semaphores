...
///////////////////////////// TEST ////////////////////////////////////
typedef struct {
    pthread_mutex_t resource_mutex;  // Мьютекс для ресурса
    pthread_mutex_t count_mutex;     // Мьютекс для счетчика читателей
    int reader_count;                // Количество активных читателей
} rwlock_t;
